...
MACROID = last | <single char identifier(CHAR)> | <single number identifier(INT)>
OPERATOR = + | - | * | / | % | < | > | <= | >= | == | != | && | ||
...
SHORTCUT = <scancode abbreviation (SCANCODE)> 
SHORTCUT = <modifier mask, e.g. LS for left shift(MODMASK)> 
