...
COMMAND = set module.MODULEID.xceleration <exponent 0-2.0, increases sensitivity at high speeds, descreases at low speeds (FLOAT)>
COMMAND = set module.MODULEID.caretSpeedDivisor <1-100 (FLOAT)>
COMMAND = set module.MODULEID.scrollSpeedDivisor <1-100 (FLOAT)>
COMMAND = set module.MODULEID.axisLockSkew <0-2.0, controls strength of axis locking properties (FLOAT)>
COMMAND = set module.MODULEID.axisLockFirstTickSkew <0-2.0, controls sensitivity to the start of mouse movement (FLOAT)>
