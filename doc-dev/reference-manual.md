...
COMMAND = set secondaryRole.advanced.ignoreTriggersFromSameHalf <prevents secondary role keys from triggering as secondary from triggers from the same half of the keyboard (BOOL)>
