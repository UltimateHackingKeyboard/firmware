...
```bash
DEVICE=right; west build --build-dir $DEVICE/build/v2-release $DEVICE -- --preset v2-release
```
...
1. The arm-none-eabi package doesn't ship with gdb by default. You can follow [this guide](https://interrupt.memfault.com/blog/installing-gdb#binaries-from-arm) to get a full toolchain installed.
